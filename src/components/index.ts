...
export default {
    ...
    Recommend: defineAsyncComponent(() => import('@/components/Common/Recommend/Recommend.vue')),
    Product: defineAsyncComponent(() => import('@/components/Common/Product/Product.vue')),
    ProductContent: defineAsyncComponent(() => import('@/components/Common/Product/ProductContent/ProductContent.vue')),
    CartButton: defineAsyncComponent(() => import('@/components/Common/Product/CartButton/CartButton.vue')),
    SizeGuide: defineAsyncComponent(() => import('@/components/Common/Product/SizeGuide/SizeGuide.vue')),
    AddToCart: defineAsyncComponent(() => import('@/components/Common/Product/AddToCart/AddToCart.vue')),
